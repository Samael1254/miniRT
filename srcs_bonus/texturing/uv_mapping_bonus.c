...
static t_vector2d	plane_mapping(t_plane plane, t_vector3d point)
{
	...
	r = get_reference_vector(plane.normal);
	tangent = ft_normalize_vector3d(ft_cross_vectors3d(r, plane.normal));
	bitangent = ft_normalize_vector3d(ft_cross_vectors3d(plane.normal,
				tangent));
